...
type BootstrapConfig struct {
	...
	SaveTempPeersForBootstrap func([]peer.AddrInfo)
	LoadTempPeersForBootstrap func() []peer.AddrInfo
}
...
func saveConnectedPeersAsTemporaryBootstrap(_ context.Context, host host.Host, cfg BootstrapConfig) error {
...
OUTER:
	...
	if len(savedPeers) < saveNumber {
		oldSavedPeers := cfg.LoadTempPeersForBootstrap()
	...
	cfg.SaveTempPeersForBootstrap(savedPeers)
...
func bootstrapRound(ctx context.Context, host host.Host, cfg BootstrapConfig) error {
	...
	tempBootstrapPeers := cfg.LoadTempPeersForBootstrap()
